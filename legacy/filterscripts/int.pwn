...
{1475.5726,1598.6417,10.8314,175.6992},
{574.9835,1679.4991,7.2411,179.9059},
{574.9547,1698.3723,12.6195,219.3862},
{-88.8061,-121.9114,3.2000,359.4476},
{489.9474,-183.8677,37.2154,358.507},
{-16.5494,-243.7637,6.1864,350.3374},
{574.8142,1679.5238,7.0840,180.5326}
};
...
"Curch",
"The Bank (Fawkes)",
"Stock Exchange (Fawkes)",
"Hippie Shopper (Fawkes)",
"Hospital (Fawkes)",
"Xoomer 24-7 (Fawkes)",
"Hospital Big (Fawkes)"
...
CMD:int(playerid,params[])
{
	...
	new playa,string[100];
	playa = strval(params);
	if(playa < 153 && playa >= 0)
	{
